...
class MacroRecorder:
    ...
    def __init__(self) -> None:
        self._macros = {}  # type: Dict[str, List[_CommandType]]
        self._recording_macro = None  # type: Optional[str]
        self._macro_count = {}  # type: Dict[int, int]
        self._last_register = None  # type: Optional[str]

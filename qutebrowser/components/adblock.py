...
import zipfile
import logging
from typing import IO, List, Set, cast
import pathlib
...
class HostBlocker:
    ...
    def __init__(self, *, data_dir: pathlib.Path, config_dir: pathlib.Path,
        ...
        self._blocked_hosts = set()  # type: Set[str]
        self._config_blocked_hosts = set()  # type: Set[str]
        self._in_progress = []  # type: List[downloads.TempDownload]
        self._done_count = 0

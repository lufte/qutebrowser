...
class WrapperLayout(QLayout):
    ...
    def __init__(self, parent=None):
        super().__init__(parent)
        self._widget = None  # type: Optional[QWidget]
        self._container = None  # type: Optional[QWidget]
...
class InspectorSplitter(QSplitter):
    ...
    def __init__(self, win_id: int, main_webview: QWidget,
        ...
        self._main_idx = None  # type: Optional[int]
        self._inspector_idx = None  # type: Optional[int]
        self._position = None  # type: Optional[inspector.Position]
        self._preferred_size = None  # type: Optional[int]

...
def log_signals(obj: QObject) -> QObject:
    ...
    """
    def log_slot(obj: QObject, signal: pyqtSignal, *args: Any) -> None:
...
def format_args(args: Sequence = None,
                kwargs: Mapping = None) -> str:
...
def dbg_signal(sig: pyqtSignal, args: Any) -> str:
...
class log_time:  # noqa: N801,N806 pylint: disable=invalid-name
    ...
    def __init__(self, logger: Union[logging.Logger, str],
        ...
        if isinstance(logger, str):
            ...
            self._logger = logger
        self._started = None  # type: Optional[datetime.datetime]
        self._action = action
